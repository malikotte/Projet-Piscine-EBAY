...
<div class="wrapper">
  ...
  <div class="container-fluid">
      ...
      <div class="row mt-5 pl-4 mr-2">
        <div class="col-sm-3">
          <div class="card">
            <img class="card-img-top" src="img/encheres550.jpg" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Aux enchères !</h5>
              <p class="card-text"><small>Gestionnaire des enchères</small></p>
              <p class="card-text" style="font-size: 14px;">Configurez ici l'ensemble des enchères, vous pouvez supprimer ou ajouter des nouvelles offres</p>
              <a href="enchere/enchere.php" class="btn btn-primary" style="background-color: #274991;border-color: #274991; color:white;">Accéder aux enchères</a>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text"><small>Gestionnaire du marché</small></p>
              <p class="card-text" style="font-size: 14px;">Configurez ici l'ensemble des enchères, vous pouvez supprimer ou ajouter des nouvelles offres</p>
              <a href="marché/marche.php" class="btn primary-color-dark" style="background-color: #274991;border-color: #274991; color:white;">Accéder au marché</a>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text"><small>Gestionnaire du marché</small></p>
              <p class="card-text" style="font-size: 14px;">Configurez ici l'ensemble des enchères, vous pouvez supprimer ou ajouter des nouvelles offres</p>
              <a href="negociation/negociation.php" class="btn primary-color-dark" style="background-color: #274991;border-color: #274991; color:white;">Accéder aux négociations</a>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="card">
            <img class="card-img-top" src="admin.png" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Liste des vendeurs</h5>
              <p class="card-text"><small>Gestionnaire des vendeurs</small></p>
              <p class="card-text" style="font-size: 14px;">Configurez ici l'ensemble des vendeurs, vous pouvez ajouter ou supprimer un vendeur</p>
              <a href="gestion/gestion.php" class="btn primary-color-dark" style="background-color: #274991;border-color: #274991; color:white;">Accéder au gestionnaire</a>
            </div>
          </div>
        </div>
  </div>
