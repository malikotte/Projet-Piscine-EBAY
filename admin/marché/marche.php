    ...
    if(isset($_FILES["itemphoto"]) AND !empty($_FILES["itemphoto"]["name"]))
   {
         ...
         if(in_array($extensionsUpload, $extensionsValides))
      {
         ...
         if($resultat)
         {
            ...
            $sql = $bdd->prepare("INSERT INTO items_achat(item_nom,itemcat,itemphoto,item_desc,prix,id_vendeur) VALUES ('$itemnom','$itemcat','$itemphoto','$item_desc','$itemprix','$id')");
            $sql->execute(array($itemnom,$itemcat,$itemphoto,$item_desc,$itemprix,$id));
...
<div class="wrapper">
    ...
    <div class="main_content">
        <div class="header">
          ...
          $liste = $bdd->query("SELECT * FROM `items_achat`");
          $tab = NULL;
