...
if(isset($_GET['success'])){
     ...
     ?>
          ...
          <?php echo $info1; ?>
          <?php
          $liste = $bdd->query("SELECT * FROM items_achat WHERE itemcat = 'musee' ");
          $tab= NULL;
              ...
              $tab .= '<div class="col-sm-3">
                          <div class="card mb-3">
                            ...
                            <div class="card-body">
                              ...
                              <center>
                              <a href="ajoutPaniermusee.php?id='.$produits['item_nom'].'" class="btn btn-secondary" style="color:white,margin:auto">J\'ajoute au panier</a></center>
                              </div>
                            </div>
                          </div>';
            }
