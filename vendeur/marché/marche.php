  ...
  if(isset($_POST['envoie'])){
    ...
    if(isset($_FILES["itemphoto"]) AND !empty($_FILES["itemphoto"]["name"]))
   {
         ...
         if(in_array($extensionsUpload, $extensionsValides))
      {
         ...
         $reqitemnom = $bdd->prepare("SELECT * FROM items_achat WHERE item_nom = ?");
         ...
         if($itemexiste==0){
           ...
           if($resultat)
           {
              ...
              $sql = $bdd->prepare("INSERT INTO items_achat(item_nom,itemcat,itemphoto,item_desc,prix,id_vendeur) VALUES ('$itemnom','$itemcat','$itemphoto','$item_desc','$itemprix','".$_SESSION['id_vendeur']."')");
...
<div class="wrapper">
    ...
    <div class="main_content">
        <div class="header">
          ...
          $liste = $bdd->query("SELECT item_nom,itemcat,itemphoto,item_desc,prix FROM items_achat WHERE id_vendeur = '".$_SESSION['id_vendeur']."' ");
          $tab = NULL;
